...
import 'screens/analytics/fleet_analytics_page.dart';
...
import 'screens/payouts/payouts_page.dart';
...
final partnerRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: "/analytics", builder: (context, state) => const FleetAnalyticsPage()),
      GoRoute(path: "/payouts", builder: (context, state) => const PayoutsPage()),

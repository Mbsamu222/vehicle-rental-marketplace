          ...
          child: _sent
              ...
              : Form(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const AuthBrandHeader(icon: Icons.storefront_rounded, tagline: "Reset your partner account password."),
                      const SizedBox(height: 28),
                      Text("Enter your account email and we'll send a reset link.", style: TextStyle(color: AppColors.mutedTextOf(context))),

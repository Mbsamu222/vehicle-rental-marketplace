            ...
            child: Column(
              ...
              children: [
                ...
                const AuthBrandHeader(
                  ...
                  tagline: "Manage your fleet, bookings, and payouts in one place.",
                ),
                const SizedBox(height: 28),
                Text("Partner sign in", style: Theme.of(context).textTheme.headlineMedium),
                const SizedBox(height: 8),
                Text("Manage your fleet and bookings.", style: TextStyle(color: AppColors.mutedTextOf(context))),
                ...
                Row(
                  ...
                  children: [
                    Text("New partner?", style: TextStyle(color: AppColors.mutedTextOf(context))),
                    TextButton(onPressed: () => context.push("/register"), child: const Text("Register your business")),
                  ],
                ),
              ],
            ),

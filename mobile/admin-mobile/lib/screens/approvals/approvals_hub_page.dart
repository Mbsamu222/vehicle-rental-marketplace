      ...
      child: AppCard(
        ...
        child: ListTile(
          ...
          leading: CircleAvatar(
            backgroundColor: AppColors.isDark(context) ? AppColors.infoBgDark : AppColors.secondary50,
            child: Icon(icon, color: AppColors.isDark(context) ? AppColors.infoTextDark : AppColors.secondary),
          ),

          ...
          flexibleSpace: FlexibleSpaceBar(
            background: vehicle.images.isNotEmpty
                ...
                : Container(
                    ...
                    child: Icon(Icons.directions_car, size: 64, color: AppColors.mutedTextOf(context)),
                  ),
          ),
        ),
        SliverToBoxAdapter(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("${vehicle.brand?.name ?? ''} · ${vehicle.year}", style: TextStyle(color: AppColors.mutedTextOf(context))),
                ...
                if (vehicle.reviews.isEmpty)
                  Text("No reviews yet.", style: TextStyle(color: AppColors.mutedTextOf(context)))
                else
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(label, style: TextStyle(fontSize: 12, color: AppColors.mutedTextOf(context))),

                    ...
                    ClipRRect(
                      ...
                      child: SizedBox(
                        ...
                        child: vehicle.primaryImageUrl != null
                            ...
                            : Container(color: AppColors.primary100, child: const Icon(Icons.directions_car, color: AppColors.primary400)),
                      ),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("${vehicle.brand?.name ?? ''} · ${vehicle.year}", style: const TextStyle(color: AppColors.primary400, fontSize: 12.5)),
                        ],
                      ),
                    ),
              ...
              AppCard(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text("Final amount is confirmed after booking is created.", style: TextStyle(fontSize: 12, color: AppColors.primary400)),

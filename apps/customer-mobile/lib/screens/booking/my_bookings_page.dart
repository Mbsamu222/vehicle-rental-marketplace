        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(booking.bookingNumber, style: const TextStyle(color: AppColors.primary400, fontSize: 12)),
              const SizedBox(height: 10),
              Row(
                children: [
                  const Icon(Icons.calendar_today_outlined, size: 14, color: AppColors.primary400),

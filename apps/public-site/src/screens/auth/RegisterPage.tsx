...
export function RegisterPage() {
  ...
  const finish = () => {
    toast.success("Account created", "Welcome to RentWheels.");
  ...
  return (
    <AuthLayout
      title={step === "phone-otp" ? "Verify your phone" : "Create your account"}
      subtitle={
        step === "phone-otp"
          ? `Enter the code we sent to ${pendingPhone} so you can log in by phone too.`
          : "Book vehicles from trusted rental partners in minutes."
      }

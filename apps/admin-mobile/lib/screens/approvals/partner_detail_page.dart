      ...
      body: partnerAsync.when(
        data: (partner) => ListView(
          ...
          children: [
            ...
            Text(partner.city?.name ?? "", style: const TextStyle(color: AppColors.primary400)),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: partner.bankDetails == null
                        ? const Text("Not provided yet.", style: TextStyle(color: AppColors.primary400))
                        : Column(
                            children: [
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: partner.documents.isEmpty
                        ? const Text("No documents uploaded yet.", style: TextStyle(color: AppColors.primary400))
                        : Column(
                            children: [
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          SizedBox(width: 110, child: Text(label, style: const TextStyle(color: AppColors.primary400))),
